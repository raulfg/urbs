...
test('la magia, la version y el tamano de cabecera son constantes del formato', () => {
  ...
  // v2 anadio la malla de relieve y la estructura del viario, y subio la
  // cabecera de 72 a 88 bytes. v3 anade la bandera de agua por poste, que no
  // toca la cabecera. El detalle esta en `celda-v2.test.js`.
